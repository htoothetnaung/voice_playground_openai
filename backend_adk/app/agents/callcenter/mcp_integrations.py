"""Shared helpers for optional OpenAI Responses MCP connector and remote MCP calls."""
...
async def run_mcp_response(
    ...
    *,
    ...
    """Run one optional OpenAI Responses call with a single MCP tool."""
    response = await client.responses.create(
        model=model or settings.stress_lab_openai_model,
        tools=[tool],
...
def normalize_mcp_output(
    ...
    """Return compact, reviewable MCP metadata without storing large third-party payloads."""
