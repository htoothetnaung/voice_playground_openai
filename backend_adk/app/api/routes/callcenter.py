"""Exposes scenario metadata, a text turn endpoint, and the ADK cascaded realtime WebSocket entry point."""
from typing import Any

from fastapi import APIRouter, Depends, HTTPException, WebSocket
from pydantic import BaseModel, Field

from app.agents.callcenter.cascaded.runtime import CallCenterAdkCascadedRuntime
        ...
        "available_architectures": [
            {
                ...
                "label": "Deepgram -> Google ADK/Gemini -> ElevenLabs",
...
async def run_callcenter_turn(
    ...
    """Run one text-only call-center turn through the Google ADK graph and return the trace payload."""
    runner = CallCenterAdkRunner(settings)
