"""Stores the role-specific system instructions for triage, billing, technical support, retention, supervisor, and escalation agents."""
...
TECHNICAL_SUPPORT_AGENT_PROMPT = f"""
# Identity
...
HUMAN_ESCALATION_AGENT_PROMPT = f"""
# Identity
